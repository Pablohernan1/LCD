...
public class remitos extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
            ...
            clientes.establecerCliente(cte.getText());
            clientes.establecerDomicilio(domicilioIng.getText());
            clientes.establecerTelefono(telefonoIng.getText());
            clientes.establecerCelular(celularIng.getText());
            clientes.establecerAparato(aparatoIng.getText());
            clientes.establecerModelo(modeloIng.getText());
            clientes.establecerSerie(serieIng.getText());
            clientes.establecerFalla(fallaIng.getText());
            clientes.establecerObservaciones(obs.getText());
            clientes.establecerImporte(importeIng.getText());

            String formatString = String.format("%%0%dd", 8);
            String formattedString = String.format(formatString, numEntero);
            
            String cliente = clientes.obtenerCliente();
            
            String sql = "insert into remitos (fecha, cliente, telefono, celular,"
                    + " domicilio, localidad, aparato, marca, falla, importe, observaciones)";
            String sql2 = "VALUE ('"+formattedString+"','"+cliente+"',"
                    + ""+clientes.obtenerTelefono()+","+clientes.obtenerCelular()+","
                    + "'"+clientes.obtenerDomicilio()+"','CABA','"+clientes.obtenerAparato()+"',"
                    + "'"+clientes.obtenerModelo()+" "+clientes.obtenerSerie()+"',"
                    + "'"+clientes.obtenerFalla()+"','"+clientes.obtenerImporte()+"',"
                    + "'"+clientes.obtenerObservaciones()+"')";

            clientes.ejecutarQuery(sql, sql2);
